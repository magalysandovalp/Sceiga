...
// Humedad
int humedad_pin = A10; // Pin A0 humedad

// Luz
int temt6000Pin = A11; // Pin A1 luz
...
//  Serial3.print(",");
  ...
  feedgps();
  gps.f_get_position(&flat, &flon);  
  distanciaMuseo = gps.distance_between (flat,flon,Museo_Lat,Museo_Lon)/ 1000;
  Serial3.print(distanciaMuseo);
  Serial3.print(",");
  
  Serial.print("Distancia al museo de los ninos (Km): ");
  Serial.println(distanciaMuseo);
  
  feedgps();
  direccionMuseo = *gps.cardinal(gps.course_to(flat,flon,Museo_Lat,Museo_Lon)); 
  
  Serial3.print(direccionMuseo);
  Serial3.print(",");
  
  Serial.print("Direccion al museo de los ninos: ");
  Serial.println(direccionMuseo);
  ...
  delay(2000); //velocidad lectura. Entre mas alto el valor, mas lenta la velocidad de impresion en el monitor serial
}
